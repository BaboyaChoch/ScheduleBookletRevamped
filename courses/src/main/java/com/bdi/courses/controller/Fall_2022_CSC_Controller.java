...
public class Fall_2022_CSC_Controller {
    ...
    public Fall_2022_CSC getFall_2022_CSCById(@PathVariable (value = "id") long fall_2022_CSCId) {
        return this.fall_2022_CSCRepository.findById(fall_2022_CSCId)
                .orElseThrow(() -> new ResourceNotFoundException("Fall_2022_CSC not found with id :" + fall_2022_CSCId));
    }
    ...
    @PutMapping("/{id}")
    public Fall_2022_CSC updateFall_2022_CSC(@RequestBody Fall_2022_CSC fall_2022_CSC, @PathVariable ("id") long fall_2022_CSCId) {
