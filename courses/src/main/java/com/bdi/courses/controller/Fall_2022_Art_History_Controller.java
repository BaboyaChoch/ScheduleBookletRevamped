...
public class Fall_2022_Art_History_Controller {
    ...
    @GetMapping("/{id}")
    public Fall_2022_Art_History getFall_2022_Art_HistoryById(
            @PathVariable(value = "id") long fall_2022_Art_HistoryId) {
        return this.fall_2022_Art_HistoryRepository.findById(fall_2022_Art_HistoryId)
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Fall_2022_Art_History not found with id :" + fall_2022_Art_HistoryId));
    }
    ...
    @PutMapping("/{id}")
    public Fall_2022_Art_History updateFall_2022_Art_History(@RequestBody Fall_2022_Art_History fall_2022_Art_History,
            @PathVariable("id") long fall_2022_Art_HistoryId) {
        Fall_2022_Art_History existingFall_2022_Art_History = this.fall_2022_Art_HistoryRepository
                .findById(fall_2022_Art_HistoryId)
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Fall_2022_Art_History not found with id :" + fall_2022_Art_HistoryId));
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Fall_2022_Art_History> deleteFall_2022_Art_History(
            @PathVariable("id") long fall_2022_Art_HistoryId) {
        Fall_2022_Art_History existingFall_2022_Art_History = this.fall_2022_Art_HistoryRepository
                .findById(fall_2022_Art_HistoryId)
                .orElseThrow(() -> new ResourceNotFoundException(
