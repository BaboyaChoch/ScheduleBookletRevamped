...
@Entity
@Table(name = "Spring_2023_CSC")
public class Spring_2023_CSC {
    ...
    public Spring_2023_CSC() {
        
    }
    public Spring_2023_CSC(int availability, int enrollment, String coursenum, String coursename, String type, int section,
